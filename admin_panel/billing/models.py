    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                fields=["name", "period"], name="subscription_unique"
            )
        ]
...
class Product(models.Model):
    ...
    name = models.CharField(
        verbose_name=_("наименование"), max_length=255, null=False, blank=False
    )
...
class Order(TimeStampedModel):
    ...
    product = models.ForeignKey(
        verbose_name=_("продукт"), to="Product", on_delete=models.RESTRICT
    )
    ...
    payment_method = models.TextField(
        verbose_name=_("способ оплаты"), null=False, blank=False
    )
